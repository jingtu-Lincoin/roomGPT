    ...
    <div className="flex max-w-6xl mx-auto flex-col items-center justify-center py-2 min-h-screen">
      ...
      <main className="flex flex-1 w-full flex-col items-center justify-center text-center px-4 mt-4 sm:mb-0 mb-8">
        {status === "authenticated" ? (
          ...
          >
            <span className="font-semibold text-gray-200">点击这里</span>购买套餐
          </Link>
        ) : (
          <a
          ...
          >
            超过{" "}
            <span className="font-semibold text-gray-200">1百万人</span>{" "}
            已经使用我们的服务
          </a>
        )}
        <h1 className="mx-auto max-w-4xl font-display text-4xl font-bold tracking-normal text-slate-100 sm:text-6xl mb-5">
          生成你的 <span className="text-blue-600">梦想</span> 房间
        </h1>
            ...
            <motion.div className="flex justify-between items-center w-full flex-col mt-4">
                ...
                !originalPhoto && (
                  <div className="h-[250px] flex flex-col items-center space-y-6 max-w-[670px] -mt-8">
                    <div className="max-w-xl text-gray-300">
                      登录以创建一个免费账户并重新设计你的房间. 你将获得3次免费点数.
                    </div>
                    <button
              ...
              {restoredImage && originalPhoto && !sideBySide && (
                <div className="flex sm:space-x-4 sm:flex-row flex-col">
                  <div>
                    <h2 className="mb-1 font-medium text-lg">原房间</h2>
                    <Image
                      alt="original photo"
                      src={originalPhoto}
                  ...
                  <div className="sm:mt-0 mt-8">
                    <h2 className="mb-1 font-medium text-lg">生成后的房间</h2>
